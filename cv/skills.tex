...
%---------------------------------------------------------
  ...
  \cvskill
    ...
    {PyTorch, MongoDB, Postgre, Docker Swarm, AWS (Lambda, API Gateway, EC2, Sagemaker), React, Nextjs, Nginx, Spring Boot, GCP, GKE, Pub/Sub, Cloud Functions, Linux, Shell (Bash/Zsh), Scrapy}
