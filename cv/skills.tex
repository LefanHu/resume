...
%---------------------------------------------------------
  \cvskill
    ...
    {Python, C/C++, Java, Kotlin, HTML/CSS, JavaScript, VHDL, Matlab} % Skills

  \cvskill
    {Technologies} % Category
    {PyTorch, Pillow, Sequelize, MongoDB, Postgre, Docker, Docker Swarm, AWS (Lambda, API gateway, EC2, Sagemaker)}
