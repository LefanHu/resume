...
\begin{cventries}
	...
	%---------------------------------------------------------
	\cventry
	{Taylor Swift Generator | \textbf{GF Project}} % Organisation
	{\underline{\href{https://lefan.ca/silly-goose}{Taylor Swift Generator | \ExternalLink}}} % Project
	{Ottawa, ON} % Location
	{January 2024 - Now} % Date(s)
	{
		\begin{cvitems} % Description(s) of project
